            ...
            return (
              <div key={service.id} className="relative group">
                <div
                  ...
                  className="flex flex-col justify-between rounded-2xl p-7 sm:p-8 bg-white border-2 border-[#D9A62E] shadow-[0_12px_28px_-4px_rgba(4,36,32,0.12),0_4px_10px_-2px_rgba(4,36,32,0.06)] hover:shadow-[0_20px_40px_-6px_rgba(4,36,32,0.22)] transition-all duration-300 relative overflow-hidden cursor-pointer h-full select-none hover:-translate-y-1.5"
                >
                  {/* Top Metallic Gold Edge */}
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between gap-3 mb-6">
                      <div className="w-13 h-13 rounded-xl bg-gradient-to-b from-[#063E38] to-[#03201C] text-[#ECCB77] flex items-center justify-center shadow-md border-2 border-[#D9A62E] shrink-0 group-hover:scale-105 transition-transform">
                        <Icon className="w-6 h-6 text-[#ECCB77] shrink-0 drop-shadow-xs" />
                      </div>
                      <div className="flex items-center gap-1.5 flex-wrap justify-end">
                        <span className="inline-flex items-center px-2.5 py-1 rounded-lg text-[11px] font-bold bg-[#FAF2DB] text-[#063E38] border border-[#D9A62E]/60 shadow-xs">
                          {service.category}
                        </span>
                        <span className="inline-flex items-center px-2.5 py-1 rounded-lg text-[11px] font-bold bg-[#063E38] border border-[#D9A62E] text-[#ECCB77] shadow-xs">
                    ...
                    <div className="space-y-3 mb-6">
                      <h3 className="text-xl font-bold text-[#063E38] font-serif group-hover:text-[#0A564E] transition-colors leading-snug">
                        {service.title}
                      </h3>
                      ...
                      {/* Clean Bullet Deliverables (No nested box clutter) */}
                      <div className="pt-4 border-t border-[#D9A62E]/30 space-y-2">
                        <p className="text-[11px] font-bold text-[#063E38] uppercase tracking-wider">Key Deliverables:</p>
                        <ul className="space-y-2">
                          {service.keyHighlights.slice(0, 3).map((hl, idx) => (
                            <li key={idx} className="flex items-start gap-2.5 text-xs text-slate-800 font-medium">
                              <Check className="w-4 h-4 text-[#D9A62E] shrink-0 mt-0.5" />
                  ...
                  {/* Single Confident Executive Action Button */}
                  <div className="pt-4 border-t border-[#D9A62E]/30 mt-auto">
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-xs font-bold text-white bg-gradient-to-b from-[#063E38] to-[#042420] hover:from-[#0A4D46] hover:to-[#063E38] border-2 border-[#D9A62E] shadow-sm transition-all cursor-pointer group-hover:border-[#ECCB77]"
                    >
